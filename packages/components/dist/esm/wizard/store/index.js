...
var reducer = function reducer() {
  ...
  switch (type) {
    ...
    case 'SET_API_DATA':
      return _objectSpread(_objectSpread({}, state), {}, {
        apiData: set(clone(state.apiData), [payload.slug], payload.data)
      });
    case 'UPDATE_WIZARD_SETTINGS':
      return _objectSpread(_objectSpread({}, state), {}, {
        apiData: set(clone(state.apiData), [payload.slug].concat(_toConsumableArray(payload.path)), payload.value)
      });
    case 'ADD_NOTICE':
      return _objectSpread(_objectSpread({}, state), {}, {
